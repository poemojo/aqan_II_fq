...
//Last modified: Fri, Sep 11, 2015 02:31:20 PM
//Codeset: UTF-8
requires maya "2016";
...
createNode transform -s -n "persp";
	...
	setAttr ".v" no;
	setAttr ".t" -type "double3" -2.624823918731312 -2.403504922737099 54.780321099544636 ;
	setAttr ".r" -type "double3" -5.7383527296567305 -3.4000000000010875 -9.9567589887152349e-17 ;
...
createNode camera -s -n "perspShape" -p "persp";
	...
	setAttr ".coi" 57.551618895543868;
...
createNode transform -n "bend1Handle";
	rename -uid "13EACCCC-1743-7FF9-94D5-9E9E86579229";
	setAttr ".t" -type "double3" 5.9604644775390625e-08 -1.1137781094984884 -5.9604644775390625e-08 ;
	setAttr ".s" -type "double3" 9.895483742378218 9.895483742378218 9.895483742378218 ;
	setAttr ".smd" 7;
createNode deformBend -n "bend1HandleShape" -p "bend1Handle";
	rename -uid "4089F38F-A843-1994-012E-A7A32B7E52C2";
	setAttr -k off ".v";
	setAttr ".dd" -type "doubleArray" 3 -1 0 0.43633231299858238 ;
	setAttr ".hw" 1.1475039541721346;
...
createNode nonLinear -n "bend1";
	rename -uid "D17B4B27-E045-1DB5-567E-D3A7E7391236";
...
createNode objectSet -n "bend1Set";
	rename -uid "B9FA78A5-224D-B369-465D-A98E5400FDF1";
	setAttr ".ihi" 0;
	setAttr ".vo" yes;
createNode groupId -n "bend1GroupId";
	rename -uid "6B785044-6D4F-C9AB-D40E-409B8501764E";
	setAttr ".ihi" 0;
createNode groupParts -n "bend1GroupParts";
	rename -uid "21F46CBB-5741-B3C8-04F4-9A88C9A25D30";
	setAttr ".ihi" 0;
	setAttr ".ic" -type "componentList" 1 "vtx[*]";
select -ne :time1;
	setAttr ".o" 2.5;
...
connectAttr "bend1GroupId.id" "pCylinderShape1.iog.og[3].gid";
connectAttr "bend1Set.mwc" "pCylinderShape1.iog.og[3].gco";
...
connectAttr "pCylinderShape1.iog.og[3]" "bend1Set.dsm" -na;
connectAttr "bend1.msg" "bend1Set.ub[0]";
connectAttr "polySplitRing12.out" "bend1GroupParts.ig";
